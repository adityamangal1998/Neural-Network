...
classifier.add(Dense(output_dim = 10, init = 'he_uniform',activation='relu',input_dim = 11))
...
model_history=classifier.fit(X_train, y_train,validation_split=0.2, batch_size = 10, nb_epoch = 100)
